function terremotosGeonamesToGeoJSON(respuestaGeonames){
    ...
    //earthquakes: nombre del webservice
    ...
    function generarPeticionTerremotos() {
        //getBounds: devuelve las coordenadas del rectángulo donde estoy en el mapa
    ...
    function filtrarTerremotos(valor) {
        map.setFilter("terremotos", [">", "numberOfFl", parseInt(valor)]);

        document.getElementById("magnitude").innerHTML = "Magnitud de  <b>" + valor ;
    }
